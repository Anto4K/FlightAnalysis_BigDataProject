...
from spark.ml.classificatoreRandomForest import train_randomForest_model
from spark.ml.metodiAux import valuta_performance
from spark.query.allQuery import preprocessing_for_classification
...
st.markdown("""Questa pagina permette di addestrare un modello di classificazione con l'obiettivo di prevedere il ritardo di un volo.  Terminato l'addestramento è possibile visualizzare alcune metriche che indicano la bontà del modello addestrato. """)
...
if(avvia_training):
    ...
    confusion_matrix_array, accuracy, f1_score, precision, recall = valuta_performance(model)
